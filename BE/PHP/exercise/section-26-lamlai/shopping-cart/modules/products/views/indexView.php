                ...
                <div class="section-detail">
                    ...
                    ?>
                        <ul class="list-item clearfix">
                            ...
                            ?>
                                <li>
                                    <a href="?mod=products&controller=index&action=detail&id=<?php echo $product['id'] ?>" title="" class="thumb">
                                        <img src="<?php echo $product['product_thumb'] ?>" alt="">
                                    </a>
                                    <a href="?mod=products&controller=index&action=detail&id=<?php echo $product['id'] ?>" title="" class="title"><?php echo $product['product_title'] ?></a>
