                        ...
                        <table class="table">
                            ...
                            <tbody>
                                ...
                                ?>
                                    <tr id="<?php echo $item['id'] ?>">
                                        ...
                                        <td id=""><?php echo currency_format($item['price']) ?></td>
                                        <td>
                                            <input type="number" id="" min='1' max='10' name="qty[<?php echo $item['id'] ?>]" value="<?php echo $item['qty'] ?>" class="num-order">
                                        </td>
                            ...
                            <tfoot>
                                <tr>
                                    <td colspan="7">
                                        <div class="clearfix">
                                            <p class="fl-right">Tổng số lượng: <span id="total-num"><?php echo get_num_order() ?></span></p> <br>
                                            <p class="fl-right">Tổng giá: <span  id="total-price"><?php echo currency_format(get_total_cart()) ?></span></p>
                                        </div>
                                    </td>
                                </tr>
                                <tr>
