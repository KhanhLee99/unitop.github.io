    ...
    <div class="container">
        ...
        <div class="row mb-5" style="border-bottom: 1px solid #ccc">
            ...
            <div class="col text-center">
                ...
                <img class="p-3"
                    style="height: 80px; width: auto; border-top: 1px solid #ccc; background-color: #f7f7f7"
                    src="{{ $selectedProduct->image }}" alt="Product Image">

                @foreach($products as $product)

                    <a href="http://localhost/unitop/Test/laravel-recommender-system/?id={{ $product->id }}" style="text-decoration: none;">
            ...
            <div class="offset-3 col-6">
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <p class="card-text text-muted">{{ $selectedProduct->name }} (${{ $selectedProduct->price }})
                        </p>
