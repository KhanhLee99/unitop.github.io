...
if(isset($_POST['checkout'])){
    // show_array($_POST);
    redirect("?mod=mail&act=sendmail");
}
?>
                        ...
                        <form method="POST">
                            ...
                            <div id="order-review-wp" class="fl-right">
                                ...
                                <?php if(!empty($list_buy)) {
                                    ...
                                    <table class="shop-table">
                                        ...
                                        <tbody>
                                            <?php foreach($list_buy as $item){
                                                ?>
                                                <tr class="cart-item">
                                                    <td class="product-name"><?php echo $item['product_title'] ?><strong class="product-quantity"><?php $item['qty']; ?></strong></td>
                                    ...
                                    ?>
                                    <p>Không có sản phẩm nào.Click <a href="?">vào đây để trở về Trang Chủ.</a></p>
                                    <?php
                                }?>
